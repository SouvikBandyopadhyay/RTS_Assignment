...
int main()
{
    ...
    {
        printf("Error opening student.index file.\n");
        index_file = fopen("student.index", "w");
        close(index_file->_fileno);
        ...
        printf("Created student.index file.\n");
    }
    // Open student.data file for appending
    FILE *data_file = fopen("student.data", "r+");
    if (data_file == NULL)
    {
        printf("Error opening student.data file.\n");
        data_file = fopen("student.data", "w");
        close(data_file->_fileno);
        ...
        printf("Created student.data file.\n");
    ...
    while (1)
    {
        ...
        printf("1. Reset file (Do it if Data and Index file is manually created and running application first time)\n");
